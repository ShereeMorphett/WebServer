...
# src files
SRC := main.cpp WebServerProg.cpp api_helpers.cpp api_get.cpp api_delete.cpp parser.cpp validateServers.cpp api_post.cpp utils.cpp request.cpp cgiHandler.cpp
